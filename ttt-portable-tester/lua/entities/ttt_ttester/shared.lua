...
function ENT:Use(ply)
   ...
   local eyetrace = false
   if ply:GetEyeTrace() and ply:GetEyeTrace().Entity != self then
      eyetrace = true
   end
   if (ply.Tested and multi == 0)  or self.Uses <= 0 or ply:IsActiveDetective() or (eyetrace) then
